...
templateFile=azureDShieldHoneypot.template
...
echo
echo "deployAzureDShieldSensor.bash"
echo "Usage: $0 [customName] [customLocation] [privateIPAddress]"
echo
echo "Example:"
echo "\"deployAzureDShieldSensor.bash specialTestingResourceGroup uswest3\" 10.0.0.10"
echo
echo "This would create an Azure Resource group named \"specialTestingResourceGroup\" "
echo "in the uswest3 location with private IP address 10.0.0.10."
echo
echo "You are executing $0 to create Resource Group ** $1 ** in location ** $2 ** with private IP address ** $3 **."
echo
echo "!!!!!!!!!!!!! WARNING !!!!!!!!!!!!!"
echo "This will also **DESTROY** any live instance of the Resource Group:"
echo
echo "	_** $1 **_"
echo
echo " and _ALL_ objects it contains!!!"
echo " .........................."
echo
